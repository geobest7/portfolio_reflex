...
def navbar() -> rx.Component:
    ...
    return rx.box(
        rx.hstack(
            ...
            rx.hstack(
                rx.link(State.nav_inicio, href="/home#inicio", on_click=State.limpiar_mensaje_formulario, color="white", class_name="nav-link"),
                rx.link(State.nav_sobre_mi, href="/home#sobre-mi", on_click=State.limpiar_mensaje_formulario, color="white", class_name="nav-link"),
                rx.link(State.nav_experiencia, href="/home#experiencia", on_click=State.limpiar_mensaje_formulario, color="white", class_name="nav-link"),
                rx.link(State.nav_formacion, href="/home#formacion", on_click=State.limpiar_mensaje_formulario, color="white", class_name="nav-link"),
                rx.link(State.nav_proyectos, href="/home#proyectos", on_click=State.limpiar_mensaje_formulario, color="white", class_name="nav-link"),
                rx.link(State.nav_github, href="/home#github", on_click=State.limpiar_mensaje_formulario, color="white", class_name="nav-link"), 
                rx.link(State.nav_contacto, href="/home#contacto", on_click=State.limpiar_mensaje_formulario, color="white", class_name="nav-link"),
                rx.link(State.nav_cv, href="/cv", on_click=State.limpiar_mensaje_formulario, color="white", class_name="nav-link"),
                spacing="6",
