...
from ..schemas.auth import Token, UserLogin, UserCreate, UserResponse, ChangePassword, ChangeUsername
...
def change_username(
    ...
    # Validar nuevo username (mínimo 3 caracteres, alfanumérico)
    if len(username_data.new_username) < 3:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
