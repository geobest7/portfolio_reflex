                        ...
                        rx.grid(
                            rx.vstack(
                                ...
                                rx.upload(
                                    rx.vstack(
                                        rx.cond(
                                            ...
                                            rx.cond(
                                                ...
                                                rx.hstack(rx.icon("upload", size=16, color="#999"), rx.text("Suelta un PDF aquí o haz clic", color="#999", size="2"), spacing="2"),
                                            ),
                                        ),
                                        align="center",
                                        justify="center",
                                    ...
                                    max_files=1,
                                    no_keyboard=True,
                                    on_drop=State.upload_diploma(rx.upload_files(upload_id="diploma_upload")),
                                ),
                            ...
                            rx.vstack(
                                ...
                                rx.upload(
                                    rx.vstack(
                                        rx.cond(
                                            ...
                                            rx.cond(
                                                ...
                                                rx.hstack(rx.icon("upload", size=16, color="#999"), rx.text("Suelta archivo aquí o haz clic", color="#999", size="2"), spacing="2"),
                                            ),
                                        ),
                                        align="center",
                                        justify="center",
                                    ...
                                    max_files=1,
                                    no_keyboard=True,
                                    on_drop=State.upload_certificado(rx.upload_files(upload_id="cert_upload")),
                                ),
