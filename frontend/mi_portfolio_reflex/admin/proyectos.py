                                ...
                                rx.upload(
                                    rx.vstack(
                                        rx.cond(
                                            ...
                                            rx.hstack(rx.icon("upload", size=16, color="#999"), rx.text("Arrastra o haz clic para subir video (MP4, max 100MB)", color="#999", size="2"), spacing="2"),
                                        ),
                                        align="center",
                                        justify="center",
                                        padding="1em",
                                ...
                                rx.upload(
                                    rx.vstack(
                                        rx.cond(
                                            ...
                                            rx.hstack(rx.icon("upload", size=16, color="#999"), rx.text("Arrastra o haz clic para subir imagen", color="#999", size="2"), spacing="2"),
                                        ),
                                        align="center",
                                        justify="center",
                                        padding="1em",
                                    ...
                                    id="imagen_upload",
                                    accept={".jpg": ["image/jpeg"], ".png": ["image/png"], ".webp": ["image/webp"]},
                                    max_files=1,
                                    no_keyboard=True,
                                ),
                                rx.button(
